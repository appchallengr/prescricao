...
@Component({
  selector: 'app-item-dieta-historico',
  templateUrl: './item-dieta-historico.component.html',
  styleUrls: ['./item-dieta-historico.component.css']
})
export class ItemDietaHistoricoComponent implements OnInit {
  ...
  constructor(
    private categoriaDietaService: ItemDietaService,
    private excelService: ExcelService,
    public dialogRef: MatDialogRef<ItemDietaHistoricoComponent>,
