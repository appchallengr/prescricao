...
@Component({
  selector: 'app-item-dieta-active',
  templateUrl: './item-dieta-active.component.html',
  styleUrls: ['./item-dieta-active.component.css']
})
export class ItemDietaActiveComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ItemDietaActiveComponent>,
  ...
  onSubmit() {
    ...
    if (this.prescricaoForm.valid) {
      ...
      this.itemDietaService.patch(this.ativar).subscribe((data: any) => {
        this.ativar.ativo ?
